...
# permisison misxin import
from django.contrib.auth.models import PermissionsMixin

class MyUserManager(BaseUserManager):
    def _create_user(self, username, email, password, first_name, last_name, is_staff, is_superuser, **extra_fields):
        """
    ...
    def create_user(self, username, email, first_name, last_name, password, **extra_fields):
        ...
        return self._create_user(username, email, password, first_name, last_name, is_staff=False, is_superuser=False,
                                 **extra_fields)
    ...
    def create_superuser(self, username, email, first_name='', last_name='', password=None, **extra_fields):
        ...
        :return: User
        """
        return self._create_user(username, email, password, first_name, last_name, is_staff=True, is_superuser=True,
                                 **extra_fields)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # make sure the reuired fields were done proprely in the model
